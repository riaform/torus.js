...
define ["source/switch-view", "demo-animate-layout-vm", "demo-base64-vm", "demo-gallery-vm" ], (SwitchView,AnimateLayoutViewModel, Base64DemoViewModel, GalleryViewModel) ->
