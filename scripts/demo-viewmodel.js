(function() {
  ...
  define(["src/switch-view", "demo-animate-layout-vm", "demo-base64-vm", "demo-gallery-vm"], function(SwitchView, AnimateLayoutViewModel, Base64DemoViewModel, GalleryViewModel) {
    var DemoViewModel;
