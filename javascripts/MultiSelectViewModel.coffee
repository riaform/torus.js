...
class MultiSelectViewModel
    ...
    beforeRemoveSource: (removedElement,index,item) =>
        ...
        $(removedElement).animate
            left: targetPos.left,
            top: targetPos.top,
            900, "easeOutElastic", () =>     # when complete, remove the floating item and show the addedElement
    ...
    afterAddSource: (sourceElement,index,item) =>
        ...
        $(floatingItem).animate
            left: pos.left ,
            top: pos.top ,
            700, "easeOutElastic", () =>     # when complete, remove the floating item and show the addedElement
                $(floatingItem).remove()
                $(addedElement).css("visibility","visible")
